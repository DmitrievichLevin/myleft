...
export type SnapScroll = DebouncedFuncLeading<
  (delta: number, onScrollFinish: Function) => Promise<void>
>;

export type SnapScrollCallback = (
  observer: SnapObserver,
  direction: SnapScrollDirection
) => void;
