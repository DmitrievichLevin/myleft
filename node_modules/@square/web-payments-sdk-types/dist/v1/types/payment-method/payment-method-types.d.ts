...
import type { AchBankAccountDetails } from './ach/types';
 ...
 */
type PaymentRequestEventValue = `${PaymentRequestEvent}`;
/**
 ...
 */
type PaymentRequestUpdater = (update: PaymentRequestUpdate) => void;
/**
 * Callback function of the [[PaymentRequestEvent.SHIPPING_CONTACT_CHANGED|`shippingcontactchanged`]] event.
 */
type ShippingContactCallback = (contact: ShippingContact) => PaymentRequestUpdate | Promise<PaymentRequestUpdate>;
/**
 * Callback function of the [[PaymentRequestEvent.SHIPPING_OPTION_CHANGED|`shippingoptionchanged`]] event.
 */
type ShippingOptionCallback = (option: ShippingOption) => PaymentRequestUpdate | Promise<PaymentRequestUpdate>;
/**
 * An appropriate callback function for the event subscription.
 */
type PaymentRequestCallback = ShippingContactCallback | ShippingOptionCallback;
/**
 * @internal
 */
 ...
 * @internal
 */
type SqEventListener = (event: SqEvent) => void;
 ...
 * }
 */
interface AchChargeTokenOptions {
    accountHolderName: string;
    intent: 'CHARGE';
    total: Money;
    /**
 ...
 * @private
 */
interface AchStoreTokenOptions {
    accountHolderName: string;
    intent: 'STORE';
}
/**
 * @private
 */
interface AchRecurringChargeTokenOptions {
    accountHolderName: string;
 ...
 * @private
 */
type AchTokenizeOptions = AchChargeTokenOptions | AchStoreTokenOptions | AchRecurringChargeTokenOptions;
/**
...
export { LineItem, MethodType, PaymentMethod, PaymentRequestCallback, PaymentRequestEvent, PaymentRequestEventValue, PaymentRequestOptions, PaymentRequestUpdater, PaymentRequestUpdate, ShippingContactCallback, ShippingErrors, ShippingOptionCallback, ShippingOption, SqEvent, SqEventListener, TokenResult, TokenError, CardTokenOptions, AchTokenOptions, AchTokenizeOptions, AchChargeTokenOptions, AchRecurringChargeTokenOptions, AchStoreTokenOptions, TokenDetails, ShippingDetails, TokenStatus, TokenizationEvent, };
