...
async function initDataClient(page, module2) {
  const dataClient = /* @__PURE__ */ Object.create(null);
  const dataClientHandle = await page.evaluateHandle(
    new Function(module2.source)
  );
  for (const name of module2.exportSymbols) {
    dataClient[name] = (...args) => dataClientHandle.evaluate(
      (client, { name: name2, args: args2 }) => client[name2](...args2),
